...
<p>Para el cálculo de los servicios de la Habitación 2 se tendrá en cuenta que esta fue desocupada el 15 de noviembre de 2025, por lo que no se incluirá en los servicios a partir de esa fecha.</p>
...
```{r}
tabla_anterior <- paste0("../input/Cons_ant/2025_", month(hoy - 30), 
                         "_Dist_SS.png")
imagen_actual <- htmltools::img(src = tabla_anterior)
imagen_actual
```
